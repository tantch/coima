...
const Ruinas = () => (
  <div>
    <p className="justified-text">a presença de vestígios construídos na atual parcela de terreno da fazenda, revela outras delimitações e ocupações humanas, outras histórias que precisamos ver,
