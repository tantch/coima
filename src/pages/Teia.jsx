...
const Teia = () => (
  <div>
    <p>2020</p>
    <p className="justified-text">espaço lúdico aéreo, suspenso nos troncos das árvores, em tela tensionada por cabos de poliester, tecidos com ponto de crochet na própria oresta, interpretando
